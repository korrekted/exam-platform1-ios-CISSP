...
final class GlobalDefinitions {
    ...
    static let apiKey = "dE5V8choEsHoVyEN"

    static let sdkDomainUrl = "https://analytics.korrekted.com"
    static let sdkApiKey = "GZCov0GqQ2YTlJMQ"

    static let applicationTag = "EXAM_CISSP"

    static let amplitudeApiKey = "b503251969f4b1d7901d2f7d1388d476"
    static let appsFlyerApiKey = "DCciCfYXjMQ8QnkdCg8qzk"

    static let appStoreUrl = "https://apps.apple.com/app/cissp-exam-certification-prep/id1572742576"
    static let appleAppID = "1572742576"
